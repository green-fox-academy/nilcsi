...
public class Main {
	...
	// write your code here
        BlogPost firstPub = new BlogPost("John Doe","Lorem Ipsum", "Lorem ipsum dolor sit amet.", "2000.05.04.");
        BlogPost secondPub = new BlogPost("Tim Urban", "Wait but why", "A popular long-form, stick-figure-illustrated blog about almost everything.", "2010.10.10.");
        BlogPost thirdPub = new BlogPost("William Turton",
